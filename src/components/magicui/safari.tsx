    ...
    <div className="w-full">
      ...
      >
        <g clipPath="url(#path0)">
          ...
          <circle fill="#E5E5E5" cx="67" cy="25" r="6" />
          <path
            fill="#E5E5E5"
          ...
          {videoSrc && (
            ...
            >
              <video
                className={`size-full overflow-hidden ${fit === 'cover' ? 'object-cover' : 'object-contain'}`}
                src={videoSrc}
                autoPlay
                loop
                muted
          ...
          {children && (
            <foreignObject
              ...
              clipPath="url(#roundedBottom)"
            >
              <div className="w-full h-full browser__template-desktop-preview">{children}</div>
            </foreignObject>
          )}
        </g>
        <defs>
